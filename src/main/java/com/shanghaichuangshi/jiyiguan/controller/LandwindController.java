...
import com.shanghaichuangshi.jiyiguan.service.LandwindService;
...
public class LandwindController extends Controller {
    ...
    public void save() {
        ...
        model.validate(Landwind.LANDWIND_NAME, Landwind.LANDWIND_PHONE, Landwind.LANDWIND_SEX, Landwind.LANDWIND_CITY, Landwind.LANDWIND_CAR);
