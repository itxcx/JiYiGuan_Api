...
public class Landwind extends Model<Landwind> {
    ...
    @Column(type = ColumnType.VARCHAR, length = 20, comment = "")
    public static final String LANDWIND_CITY = "landwind_city";
    ...
    public String getLandwind_city() {
        return getStr(LANDWIND_CITY);
    }

    public void setLandwind_city(String landwind_city) {
        set(LANDWIND_CITY, landwind_city);
    }
