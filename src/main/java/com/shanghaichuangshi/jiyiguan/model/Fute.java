...
public class Fute extends Model<Fute> {
    ...
    @Column(type = ColumnType.VARCHAR, length = 20, comment = "福特经销商")
    public static final String FUTE_PLATFORM = "fute_platform";
    ...
    public String getFute_platform() {
        return getStr(FUTE_PLATFORM);
    }

    public void setFute_platform(String fute_platform) {
        set(FUTE_PLATFORM, fute_platform);
    }
}