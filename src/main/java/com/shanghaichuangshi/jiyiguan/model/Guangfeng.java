package com.shanghaichuangshi.jiyiguan.model;
...
public class Guangfeng extends Model<Guangfeng> {
    ...
    @Column(type = ColumnType.VARCHAR, length = 20, comment = "")
    public static final String GUANGFENG_IP = "guangfeng_ip";
    ...
    public Object getGuangfeng_number() {
        return get(GUANGFENG_NUMBER);
    }

    public void setGuangfeng_number(String guangfeng_number) {
    ...
    public String getGuangfeng_ip() {
        return getStr(GUANGFENG_IP);
    }

    public void setGuangfeng_ip(String guangfeng_ip) {
        set(GUANGFENG_IP, guangfeng_ip);
    }
}